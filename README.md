...
:exclamation: This package is deprecated. Use now the [nsql-cache](https://github.com/sebelga/nsql-cache) + [nsql-cache-datastore](https://github.com/sebelga/nsql-cache-datastore) packages for your Google Datastore entities caching.
