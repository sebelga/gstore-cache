...
module.exports = cache => {
    ...
    const msetWithKind = (keysValues, _options, redisOptions) => {
        ...
        for (let i = 0; i < length; i += 1) {
            ...
            queryKey = queryToString(keysValues[index]);
            queryData = keysValues[index + 1];
            ...
            // Cache the Query by EntityKind
            cacheHandlers.push(
                _this.cacheQueryEntityKind(queryKey, [entities, queryData[1]], query.kinds[0], redisOptions)
            );
