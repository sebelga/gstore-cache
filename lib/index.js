        ...
        const proceed = () => {
            ...
            if (this._config.stores.length > 1) {
                ...
                if (self._redisClient) {
                    ...
                    const storeWithoutRedis = this._config.stores.filter(c => c.store.name !== 'redis');
    ...
    deleteCacheManager(cb) {
        ...
        if (this._cacheManager) {
            return this._cacheManager.reset(() => {
                ...
                if (this._cacheManagerNoRedis) {
                    return this._cacheManagerNoRedis.reset(() => {
                        self._cacheManagerNoRedis = undefined;
                        return cb();
                    });
                }
