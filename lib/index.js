...
class GstoreCache extends EventEmitter {
    ...
    init(settings) {
        ...
        if (typeof settings === 'undefined' && typeof this._cacheManager !== 'undefined') {
            ready();
            return;
        }

        this._ds = (settings && settings.datastore) || this._ds;
...
//     gstoreCacheInstance.init(config, db);

//     return gstoreCacheInstance;
// };

// const get = () => gstoreCacheInstance;
